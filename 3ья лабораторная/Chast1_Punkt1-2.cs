    ...
    static void Main(string[] args)
    {
        ...
        */
        ...
        try
        {
            ...
            var foundUnit_QuerySyntax = FindUnit_QuerySyntax(units, tanks, "Резервуар 2");
            ...
            var factory_QuerySyntax = FindFactory_QuerySyntax(factories, foundUnit_QuerySyntax);
            // Поиск завода, которому принадлежит найденная установка (синтаксис методов)
            // var factory_MethodSyntax = FindFactory_MethodSyntax(factories, foundUnit_MethodSyntax);

            // Вывод информации о принадлежности "Резервуара 2" установке и заводу (синтаксис запросов)
            Console.WriteLine($"Резервуар 2 принадлежит установке {foundUnit_QuerySyntax.Name} и заводу {factory_QuerySyntax.Name} (синтаксис запросов)");
            // Вывод информации о принадлежности "Резервуара 2" установке и заводу (синтаксис методов)
            // Console.WriteLine($"Резервуар 2 принадлежит установке {foundUnit_MethodSyntax.Name} и заводу {factory_MethodSyntax.Name} (синтаксис методов)\n");
            ...
            // Вывод общего объема резервуаров (синтаксис запросов)
            Console.WriteLine($"Общий объем резервуаров: {totalVolume_QuerySyntax} (синтаксис запросов)");
            // Вывод общего объема резервуаров (синтаксис методов)
